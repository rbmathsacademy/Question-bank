with open('app/admin/analytics/generateBatchSchoolReportPDF.ts', 'w', encoding='utf-8') as f: f.write(r'''import jsPDF from 'jspdf';
...
export const generateBatchSchoolReportPDF = (batchName: string, students: any[], getCorrelationData: (s: any, e: any) => any) => {
    ...
    autoTable(doc, {
        startY: 48,
        head: [['Student Name', 'School', 'Exam', 'School Actual', 'System Prediction', 'Status', 'Insight']],
        body: tableData,
